...
Begin VB.Form frmBillingTransaction2 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmBillingTransaction2.frx":0000
   ScaleHeight     =   6435
   ScaleWidth      =   6285
   ...
   Begin VB.Image Image1 
      Height          =   615
      Left            =   0
      Picture         =   "frmBillingTransaction2.frx":2EE27
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9000
   End
End
Attribute VB_Name = "frmBillingTransaction2"
...
Private Sub cmdOK_Click()
    If MsgBox("Print Transaction?...", vbYesNo + vbQuestion, "Receipt...") = vbYes Then
         ...
         DataEnvironment1.rssqlProductReceipt.Open
        rptProductTransaction.Sections("Section5").Controls("lblTotalAmount").Caption = Format(txtTotalAmount.Text, "#,##0.00")
        rptProductTransaction.Sections("Section5").Controls("labelCash").Caption = Format(txtCash.Text, "#,##0.00")
        rptProductTransaction.Sections("Section5").Controls("labelChange").Caption = Format(txtChange.Text, "#,##0.00")
        rptProductTransaction.Show vbModal
        DataEnvironment1.rssqlProductReceipt.Close
  Else: Unload Me
    End If
        Unload Me
End Sub
