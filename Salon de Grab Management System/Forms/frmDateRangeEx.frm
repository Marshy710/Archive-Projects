...
Begin VB.Form frmDateRangeEx 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "frmDateRangeEx.frx":0000
   ScaleHeight     =   3165
   ScaleWidth      =   3585
   ...
   Begin VB.Image Image1 
      Height          =   615
      Left            =   0
      Picture         =   "frmDateRangeEx.frx":16C842
      Stretch         =   -1  'True
      Top             =   0
      Width           =   9000
   End
End
Attribute VB_Name = "frmDateRangeEx"
...
Private Sub cmdOK_Click()
    ...
    varDateFrom = DateValue(dateFrom.Value)
    varDateTo = DateValue(dateTo.Value)
    varOk = True
    Unload Me
End Sub

Private Sub Form_Load()
    dateFrom.Value = DateValue(Now)
    dateTo.Value = DateValue(Now)
End Sub
